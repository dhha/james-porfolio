<template>
  <Layout :background="'gradient'" :no-sidebar="true">
    <Header :no-sidebar="true" />
    ...
    -->
      <div class="profile">
        ...
        <!--<div class="typed">Web Designer</div>-->
        <TypingAnimation />
...
import LanguagesSkills from "../src/components/LanguagesSkills.vue";
  ...
  head() {
    return {
      link: [
        ...
        {
          rel: "stylesheet",
          href: "css/demos/demo-2-colors.css",
        },
        {
          rel: "stylesheet",
          href: "css/new-skin/classic-skin.css",
        },
        {
          rel: "stylesheet",
          href: "css/template-dark/dark.css",
        },
      ],
    };
  },
